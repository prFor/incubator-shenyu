...
/**
 * ShenyuSpringMvcClientDelegate .
 */
public class ShenyuSpringMvcClientDelegate implements ShenyuSpringMvcClient {
    
    private final ShenyuClient shenyuClient;
    
    public ShenyuSpringMvcClientDelegate(final ShenyuClient shenyuClient) {
