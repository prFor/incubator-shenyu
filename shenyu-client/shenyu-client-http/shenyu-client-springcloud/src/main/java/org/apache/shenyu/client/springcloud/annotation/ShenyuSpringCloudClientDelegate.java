...
/**
 * ShenyuSpringCloudClientDelegation .
 */
public class ShenyuSpringCloudClientDelegate implements ShenyuSpringCloudClient {
    
    private final ShenyuClient shenyuClient;
    
    /**
     * Instantiates a new Shenyu spring cloud client delegate.
     *
     * @param shenyuClient the shenyu client
     */
    public ShenyuSpringCloudClientDelegate(final ShenyuClient shenyuClient) {
