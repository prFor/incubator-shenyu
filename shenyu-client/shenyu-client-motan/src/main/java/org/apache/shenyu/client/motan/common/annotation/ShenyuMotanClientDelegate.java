...
/**
 * ShenyuMotanClientDelegate .
 */
public class ShenyuMotanClientDelegate implements ShenyuMotanClient {
    
    private final ShenyuClient shenyuClient;
    
    /**
     * Instantiates a new Shenyu motan client delegate.
     *
     * @param shenyuClient the shenyu client
     */
    public ShenyuMotanClientDelegate(final ShenyuClient shenyuClient) {
